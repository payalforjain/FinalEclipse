...
public class Numbers {
	...
	public static String DecimalToRomanNumeral(int num) {
	  ...
	  //1)	Remove repeating characters from a string. Eg: "Green Apple" O/p: Grn Apl No extra memory allowed
	   ...
	   // You have got a range of numbers between 1 to N.You need to write a program to find out the duplicate number. 
