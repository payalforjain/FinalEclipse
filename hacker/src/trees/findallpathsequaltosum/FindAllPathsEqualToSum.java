...
public class FindAllPathsEqualToSum {
    ...
    * */
    public static List<String> findAllPathsFromRoot(BSTNode rootNode, int inputSum) {
        sum = inputSum;
    ...
    private static void findPathsFromRoot(BSTNode currentNode, List<String> pathsList, int counter, String inputString) {
        if (currentNode == null) {
            return;
        }
        ...
        findPathsFromRoot((BSTNode) currentNode.getLeftChild(), pathsList, counter, inputString);
        findPathsFromRoot((BSTNode) currentNode.getRightChild(), pathsList, counter, inputString);
    }

    /*
    * Paths not necessarily starting from root.
    * */
    public static List<String> findAllPaths(BSTNode rootNode, int sum) {
    ...
    private static void findAllPaths(BSTNode node, int sum, List<Integer> path) {
        if (node == null) {
            return;
        }
        ...
        findAllPaths((BSTNode) node.getLeftChild(), sum, path);
        findAllPaths((BSTNode) node.getRightChild(), sum, path);
