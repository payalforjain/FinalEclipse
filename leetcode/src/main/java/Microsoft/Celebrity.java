...
abstract class Celebrity {
   ...
   and among them, there may exist one celebrity. The definition of a celebrity is that all the other n - 1 people know him/her but he/she does not know any of them.
...
Note: There will be exactly one celebrity if he/she is in the party. Return the celebrity's label if there is a celebrity in the party. If there is no celebrity, return -1.
   ...
   //A O(n) time O(1) Space Solution:
    public int findCelebrity(int n) {
        ...
        for (int i = 0; i < n; i++) {
            if (i != celebrity) {
                // celebrity know other guy or other guy doesn't know about celenrity then its false
