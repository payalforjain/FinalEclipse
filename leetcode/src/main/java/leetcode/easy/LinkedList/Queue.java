...
public class Queue<Item> {
	...
	// you can reverse using stack to. Just similar to reversing a list or
	// String
	...
	public static void main(String args[]) {
		...
		/*
		 * a.middlelinkedlist(); a.recursiveReverse();
		 * System.out.println("recursive" +a.toString()); a.iterativeReverse();
		 */
